...
/**
 * A {@link com.afollestad.silk.adapters.SilkAdapter} that displays {@link com.afollestad.Tabsui.Tab} and {@link com.afollestad.Tabsui.TabHeader} objects in a {@link com.afollestad.Tabsui.TabListView}.
 *
 * @author Aidan Follestad (afollestad)
 */
public class TabCursorAdapter<ItemType extends TabBase<ItemType> & SilkCursorItem<ItemType>> extends SilkCursorAdapter<ItemType> {
     ...
     */
    public TabCursorAdapter(Context context, Class<? extends SilkCursorItem> cls) {
        super(context, cls);
     ...
     */
    public TabCursorAdapter(Context context, Class<? extends SilkCursorItem> cls, int tabLayoutRes) {
        this(context, cls);
     ...
     */
    public TabCursorAdapter(Context context, Class<? extends SilkCursorItem> cls, int tabLayoutRes, int tabLayoutNoContentRes) {
        this(context, cls, tabLayoutRes);
     ...
     */
    public final TabCursorAdapter<ItemType> setAccentColor(int color) {
        mAccentColor = color;
        return this;
    }
     ...
     */
    public final TabCursorAdapter<ItemType> setAccentColorRes(int colorRes) {
     ...
     */
    public final TabCursorAdapter<ItemType> setPopupMenu(int menuRes, Tab.TabMenuListener<ItemType> listener) {
        mPopupMenu = menuRes;
     ...
     * set to {@link com.afollestad.tabsui.Tab}s.
     */
    public final TabCursorAdapter<ItemType> setTabsClickable(boolean clickable) {
     ...
     */
    public final TabCursorAdapter<ItemType> registerLayout(int layoutRes) {
